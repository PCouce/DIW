Actividad: elige tu paleta de colores y tipografía
Contexto
...
Punto de partida
Trabaja sobre tu copia personal del repositorio de la plantilla (la que creaste con "Use this template" y clonaste en VS Code). El archivo que vas a modificar es styles.css, concretamente el bloque :root situado al principio, donde están definidas todas las variables de color y tipografía.

Desarrollo de la actividad
1. Elige una paleta de color
Entra en coolors.co y genera paletas hasta encontrar una que te convenza (pulsa la barra espaciadora para generar combinaciones aleatorias, o parte de un color que te guste y deja que la herramienta proponga el resto).
...
--color-boton-primario (+ su versión hover)	Color del botón de la acción principal
...
Guarda una captura de pantalla de cada variante y responde por escrito a estas preguntas:
...
Si este sitio fuera real, ¿qué tipo de negocio o marca encajaría mejor con cada una de las dos variantes?
Qué tienes que entregar
Tu styles.css final, con la paleta y tipografía que hayas elegido como versión definitiva.
Las dos capturas de pantalla (variante segura y variante de alto contraste).
Un párrafo breve (5-8 líneas) respondiendo a las preguntas de reflexión del apartado anterior.
Cómo entregarlo
Haz commit y push de tus cambios a tu propio repositorio en GitHub (el que creaste a partir de la plantilla), y añade las capturas y el texto de reflexión en un archivo reflexion.md dentro de tu repositorio. Entrega el enlace a tu repositorio.
...
Comparativa segura vs. alto contraste	Ambas variantes están correctamente diferenciadas y documentadas con capturas
